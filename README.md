...
- **Força loja aos 13 meses (R$55k)**: Para investimento de R$ 55.000, paga a segunda loja no mês 12 e abre no mês 13 automaticamente; a partir do mês 13 as adições automáticas voltam a seguir a regra padrão (se pagar o CAPEX sem passar do limite do investimento)
