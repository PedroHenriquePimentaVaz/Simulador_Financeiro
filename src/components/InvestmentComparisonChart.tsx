    ...
    <div style={{ 
      ...
      <div style={{ marginBottom: '40px' }}>
        <h3 style={{ 
          ...
          Comparação de Retorno - {currentPeriod.label}
        </h3>
        ...
        <div style={{ 
          ...
          <div style={{
            ...
            <div style={{ marginBottom: '8px' }}>
              <strong>Valor Final:</strong> R$ {franchiseValue.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}
            </div>
            <div style={{ marginBottom: '8px' }}>
              <strong>Lucro:</strong> R$ {franchiseProfit.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}
            </div>
            <div style={{ 
              fontSize: '18px', 
              fontWeight: '700', 
          ...
          {comparisonData.map((investment, index) => (
            <div key={index} style={{
              ...
              <div style={{ marginBottom: '8px' }}>
                <strong>Taxa Anual:</strong> {investment.annualRate}%
              </div>
              <div style={{ marginBottom: '8px' }}>
                <strong>Valor Final:</strong> R$ {investment.value.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}
              </div>
              <div style={{ marginBottom: '8px' }}>
                <strong>Lucro:</strong> R$ {investment.profit.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}
              </div>
              <div style={{ 
                fontSize: '18px', 
                fontWeight: '700', 
